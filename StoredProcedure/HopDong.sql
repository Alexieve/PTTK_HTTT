...
BEGIN
    ...
    -- Nếu không có bản ghi nào thỏa mãn điều kiện, trả về 1 và 2
    IF v_count = 0 THEN
        OPEN P_RES FOR
            SELECT 'HD00000001' AS MAHOPDONG, TO_DATE('01/01/2001', 'MM/DD/YYYY') AS NGAYTT FROM DUAL;
    ELSE
        -- Nếu có bản ghi thì thực hiện truy vấn thông thường
        OPEN P_RES FOR
