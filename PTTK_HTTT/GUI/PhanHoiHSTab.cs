...
namespace GUI
{
    public partial class PhanHoiHSTab : Form
    {
        ...
        {
            InitializeComponent();
            HopDongBtn_Click(HopDongBtn, null);
        }

        public void openChildForm(Form childForm)
        {
            if (childForm is PhanHoiHS_DSHoSo)
            {
                ActiveTab(HoSoBtn);
            }
        ...
        {
            openChildForm(new PhanHoiHS_DSHopDong(this));
            ActiveTab(sender);
        ...
        {
            openChildForm(new PhanHoiHS_DSHoSo(this));
            ActiveTab(sender);
