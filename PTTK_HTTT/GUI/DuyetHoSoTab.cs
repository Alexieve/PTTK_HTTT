...
namespace GUI
{
    public partial class DuyetHoSoTab : Form
    {
        ...
        {
            if (childForm is DuyetHoSo_DSHoSo)
            {
                ActiveTab(HoSoBtn);
            }
        ...
        {
            openChildForm(new DuyetHoSo_DSBaiDang(this));
            ActiveTab(sender);
        ...
        {
            openChildForm(new DuyetHoSo_DSHoSo(this));
            ActiveTab(sender);
