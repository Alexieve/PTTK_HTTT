...
namespace GUI
{
    public partial class DuyetHoSo_DSBaiDang : Form
    {
        private DuyetHoSoTab duyetHoSoTab;
        public DuyetHoSo_DSBaiDang(DuyetHoSoTab duyetHoSoTab)
        {
            InitializeComponent();
            addSampleData();
        ...
        {
            this.duyetHoSoTab.openChildForm(new DuyetHoSo_DSHoSo(this.duyetHoSoTab));
        }
    }
}
