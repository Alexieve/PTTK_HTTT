...
namespace GUI
{
    public partial class DN_PhanHoiHS_ChiTietHS : Form
    {
        ...
        public DN_PhanHoiHS_ChiTietHS(string MAHOPDONG, string MAUV, string KETQUA)
        {
            InitializeComponent();
        ...
        {
            hsUngTuyenBll.Update_KetQua(MAUV, MAHOPDONG, 6);
        ...
        {
            hsUngTuyenBll.Update_KetQua(MAUV, MAHOPDONG, 5);
            MessageBox.Show("Phản hồi thành công");
            this.Close();
        }
    }
