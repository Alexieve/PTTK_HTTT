...
namespace GUI
{
    partial class DeXuatUuDai
    {
        ...
        private void InitializeComponent()
        {
            ...
            dataGridView1.Rows.Add(1, "XX", 5, 5, "27/02/2024","hợp lí");
            dataGridView1.Rows.Add(0, "XX", 5, 5, "27/02/2024");
            dataGridView1.Rows.Add(0, "XX", 5, 5, "27/02/2024");
            dataGridView1.Rows.Add(0, "XX", 5, 5, "27/02/2024");
            dataGridView1.Rows.Add(0, "XX", 5, 5, "27/02/2024");
            dataGridView1.Rows.Add(0, "XX", 5, 5, "27/02/2024");
            ...
            dataGridView1.Rows.Add(0, "XX", 5, 5, "27/02/2024");
            dataGridView1.Rows.Add(0, "XX", 5, 5, "27/02/2024");
            dataGridView1.Rows[1].Cells[5].Style.BackColor = Color.LightGray;
            dataGridView1.Rows[2].Cells[5].Style.BackColor = Color.LightGray;
            dataGridView1.Rows[3].Cells[5].Style.BackColor = Color.LightGray;
            dataGridView1.Rows[4].Cells[5].Style.BackColor = Color.LightGray;
            dataGridView1.Rows[5].Cells[5].Style.BackColor = Color.LightGray;
            dataGridView1.Rows[6].Cells[5].Style.BackColor = Color.LightGray;
            dataGridView1.Rows[7].Cells[5].Style.BackColor = Color.LightGray;
            dataGridView1.Rows[8].Cells[5].Style.BackColor = Color.LightGray;
            dataGridView1.Rows[9].Cells[5].Style.BackColor = Color.LightGray;
            // 
            // MaDN
            // 
