...
namespace GUI
{
    public partial class PhanHoiHS_DSHopDong : Form
    {
        private PhanHoiHSTab phanHoiHsTab;
        public PhanHoiHS_DSHopDong(PhanHoiHSTab phanHoiHsTab)
        {
            InitializeComponent();
            addSampleData();
        ...
        {
            this.phanHoiHsTab.openChildForm(new PhanHoiHS_DSHoSo(this.phanHoiHsTab));
        }
    }
}
